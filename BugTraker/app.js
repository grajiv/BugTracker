...
var ProductList = React.createClass({
    componentDidMount : function(){
        ...
        fetch(url, {
            ...
            response.json().then(function(productData){
                                ...
                                that.setState({list:productData.map(function(productData){
    ...
    getInitialState : function(){
       console.log("getinitialstate in PRoductList");
        return {
            list : [],
            productTotalValue : 0
        };
    ...
    render : function(){
        ...
        return (
            <li>
                ...
                <input type="text" ref="txtCost" value={this.state.product.cost} onChange={this.updateProduct}/>
                <input type="text" ref="txtUnits" value={this.state.product.units} onChange={this.updateProduct}/>
